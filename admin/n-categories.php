...
<?php
	if (isset($_GET['ecid'])) {
		if(filter_var($_GET['ecid'], FILTER_VALIDATE_INT, array('min_range'=>1))) {
			include('../inc/edit-n-categories.php');
		} else {
			redirect_to('admin/index.php');
		}
	} elseif(isset($_GET['dcid'])) {
		if(filter_var($_GET['dcid'], FILTER_VALIDATE_INT, array('min_range'=>1))) {
			include('../inc/delete-n-categories.php');
		} else {
			redirect_to('admin/index.php');
		}
	} else {
		include('../inc/add-n-categories.php');
	}
?>
...
<!-- HIỂN THỊ DANH MỤC BÀI VIẾT -->
	...
	<table>
    	<thead>
    		<tr>
    			<th><a href="n-categories.php?sort=cat">Tên danh mục</a></th>
    			<th><a href="n-categories.php?sort=pos">Vị trí</th>
    			<th><a href="n-categories.php?sort=by">Người tạo</th>
                <th>Edit</th>
                <th>Delete</th>
    		</tr>
    	</thead>
    	...
    	?>
            <tr>
                ...
                <td class='edit'><a href="n-categories.php?ecid=<?php echo $cats['cat_id']; ?>"><img src="../images/b_edit.png" alt="edit"></a></td>
                <td class='delete'><a href="n-categories.php?dcid=<?php echo $cats['cat_id']; ?>"><img src="../images/b_drop.png" alt="drop"></a></td>
            </tr>
        <?php endwhile; ?>
    	</tbody>
    </table>
